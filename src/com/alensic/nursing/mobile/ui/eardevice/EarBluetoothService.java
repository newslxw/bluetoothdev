...
import com.alensic.nursing.mobile.ui.blood.BloodConnectThread;
 ...
 *
 */
public class EarBluetoothService  extends BluetoothService {

    
	public EarBluetoothService(Context context, Handler handler) {
	...
	public ConnectThread createConnectThread() {
		return new EarConnectThread(this,this.getMmMac(),this.getmDeviceName(),this.getSleepTime(),this.getnTimeout());
	}
